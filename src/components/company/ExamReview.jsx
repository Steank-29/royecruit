                                    ...
                                    <TableRow
                                        ...
                                        <TableCell component="th" scope="exam" style={{ color: "#222831", fontSize: "16px", fontWeight: "600", padding: "25px" }}>
                                            {exam.examReview.map((examR, indexi) => (<>
                                                <Label><span style={{ color: "black", fontSize:22, fontWeight:"bold", fontFamily:"Oswald" }}>{"Question Title Is:  "}</span>{examR.qTitle}</Label>
                                                <br />
                                                <Label><span style={{ color: "royalblue", fontSize:20, fontWeight:"bold", fontFamily:"Oswald" }}>{"Candidate Answer Is: "}</span> {examR.qAnswers}</Label>
                                                <br />
                                                <Label><span style={{ color: "green",fontSize:20, fontWeight:"bold", fontFamily:"Oswald" }}>{"Correct Answer Is: "}</span>{examR.qCorrect}</Label>
                                                <br />
                                                <br />
                                            </>))}
                                        </TableCell>
